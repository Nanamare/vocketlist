 ...
 * @since 2017. 4. 8.
 */
public class NoticeHeaderViewHolder extends ParentViewHolder<ListItemNotice, NoticeModel.Notice> {
     ...
     */
    public NoticeHeaderViewHolder(@NonNull View itemView) {
        super(itemView);
     ...
     * @param notice
     */
    public void bind(ListItemNotice notice) {
        tvLabel.setText(notice.getTitle());
    }
