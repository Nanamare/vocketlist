...
import com.vocketlist.android.api.errorchecker.BaseServiceErrorChecker;
import com.vocketlist.android.api.errorchecker.FcmRegisterErrorChecker;
...
public class UserServiceManager {
    private static UserService sUserService = retrofit.create(UserService.class);

    public static Observable<Response<BaseResponse<Boolean>>> registerFcmToken(String fcmToken) {
        return sUserService
