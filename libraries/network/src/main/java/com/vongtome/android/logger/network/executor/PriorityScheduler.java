 ...
 * the License.
 */
package com.vongtome.android.logger.network.executor;
...
public final class PriorityScheduler extends Scheduler {
    private static Executor executor = ServiceExecutors.getAPIExecutor();
    ...
    public PriorityScheduler(Priority priority) {
    ...
    public Worker createWorker() {
        return new ExecutorSchedulerWorker(executor, priority);
    }
    ...
    static final class ExecutorSchedulerWorker extends Worker implements Runnable {
        ...
        public ExecutorSchedulerWorker(Executor executor, Priority priority) {
